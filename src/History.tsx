...
export default function History() {
    return(
        <div className="flex flex-col items-center">
            <div className=" max-w-[1000px] flex md:text-left text-center flex-col py-12 px-3 gap-8">
